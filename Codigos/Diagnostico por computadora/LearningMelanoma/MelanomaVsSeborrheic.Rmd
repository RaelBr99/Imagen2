...
MelanomaFeatures <- read.csv("MelanomaLesionFeatures.csv", header=FALSE)
SeborrheicFeatures <- read.csv("SeborrheicLesionFeatures.csv", header=FALSE)
NevusFeatures <- read.csv("NevusLesionFeatures.csv", header=FALSE)
MelanomaControlFeatures <- read.csv("MelanomaControlFeatures.csv", header=FALSE)
SeborrheicControlFeatures <- read.csv("SeborrheicControlFeatures.csv", header=FALSE)
NevusControlFeatures <- read.csv("NevusControlFeatures.csv", header=FALSE)
...
## Plot performance KNN
```{r}
performance <- predictionStats_binary(cvKNN$medianTest,"KNN")
par(op)
performance$CM.analysis
```


## Learning Melanoma with SVM
```{r}
...
```{r}
performance <- predictionStats_binary(cvSVM$medianTest,"SVM")
par(op)
performance$CM.analysis
```
...
## Plot performance
```{r}
performance <- predictionStats_binary(cvNB$medianTest,"Naive Bayes")
par(op)
performance$CM.analysis
```


## Learning Melanoma with Adaboost ya
```{r}
...
## Plot performance ya
```{r}
performance <- predictionStats_binary(cvADA$medianTest,"Adaboost")
par(op)
performance$CM.analysis
```


## Learning Melanoma with GBM ya
```{r}
...
## Plot performance
```{r}
performance <- predictionStats_binary(cvgbm$medianTest,"GBM")
par(op)
performance$CM.analysis
```
